    ...
    <>
      ...
      <main className="container">
        ...
        <p className="subtitle">
          Incoming ECE Student at <a href="https://www.cmu.edu/" target="_blank" rel="noreferrer">Carnegie Mellon University</a>
        </p>

        <div className="profile-section prose">
          <img
            src="https://placehold.co/220x280/e0e0e0/666?text=Photo"
            alt="Darren Pinto"
          ...
          <p>
            Previously, I interned at <a href="#">Cadre Research</a>, where I worked on embedded systems,
          ...
          <p>
            Outside of engineering, I develop games on Roblox. My projects have reached over 6 million
          ...
          <p>
            You can contact me at {profile.contact.email.replace('@', '[at]').replace('.', '[dot]')}.
          </p>
        </div>
      </main>

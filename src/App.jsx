      ...
      if (!ticking) {
        window.requestAnimationFrame(() => {
          if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 200) {
            const words = Array(6).fill("Building").join(" • ");
            setInfiniteLines(prev => {
              return [...prev, words, words];
            });
          }
          ticking = false;
        });
      ...
      <main className="container">
        <div className="animate-blur-fade delay-100">
          ...
          <p className="subtitle">
            Student and Robotics Researcher at <a href="https://www.cmu.edu/" target="_blank" rel="noreferrer">Carnegie Mellon University</a>
          </p>
        </div>
